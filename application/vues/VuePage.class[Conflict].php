        ...
        if($sFiltre == ""){
            $sHtml .= '
                ...
                <ul class="filtres">
                    ...
                    <li>
                        <div class="filtreDeux" data-sfiltre = "Auteur">Auteur</div>
                    </li>
                    ...
                    <li>
                        <div class="filtreSix" data-sfiltre = "Tous">Tous</div>
                    </li>
    ...
    public function afficherApropos(Page $oPage, $sMsg = '')
    {
        ...
        <div class='ligne' id='animationLigne'></div>
            ...
            <div class='paragraphe' id='animationTexte1'>
                       ...
                       Habités par le fol espoir de voir (re)vivre la littérature dans le monde d’aujourd’hui et de demain, les étudiantes et étudiants, professeures et professeurs du <a class=\"mon_lien\"href='https://www.cmaisonneuve.qc.ca/programmes/preuniversitaires/arts-lettres-communication'>programme Arts, lettres et communication</a>  du <a class=\"mon_lien\" href='https://www.cmaisonneuve.qc.ca'>Collège de Maisonneuve</a>
                       créent leur propre revue littéraire, LE FOL ESPOIR.

            </div>

            <div class='paragraphe' id='animationTexte2'>
                            Dans le contexte où les réseaux sociaux, les jeux vidéos, les téléséries ou les médias audiovisuels occupent tout le champ visuel et auditif, ces amoureux fous et amoureuses folles de la littérature font le pari que les lettres ne sont pas « dans le champ », même qu’elles demeurent plus pertinentes que jamais à l’ère des chiffres du numérique. Un fol espoir?
            </div>
            
            <div class='paragraphe' id='animationTexte3'>" . $oPage->getsTextePage() . "</div>
